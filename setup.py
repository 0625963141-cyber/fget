...
setup(
    name='fileget',  # The name of your package on PyPI
    ...
    author='Anonymousethc4',
    author_email='cs7778503@gmail.com',
    url='https://github.com/0625963141-cyber',  # Replace with your repo URL
    ...
    entry_points={
        'console_scripts': [
            'fileget=fileget.fileget:main',  # Exposes fget as a CLI command
        ],
    },
    classifiers=[
